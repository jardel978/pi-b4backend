...
create table tb_produto (produto_id bigint generated by default as identity, descricao varchar(255), nome varchar(255), categoria_id bigint, cidade_id bigint, primary key (produto_id));
create table tb_reserva (reserva_id bigint generated by default as identity, data_final date, data_inicio date, horario_inicio time, usuario_id bigint, produto_id bigint, primary key (reserva_id));
