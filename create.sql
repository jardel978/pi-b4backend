...
create table tb_produto (produto_id bigint generated by default as identity, descricao varchar(3000), endereco varchar(255), latitude bigint, limite_pessoas_por_dia integer, longitude bigint, nome varchar(255), nota_avaliacao_clientes bigint, qtd_avaliacoes integer, valor_por_pessoa bigint, categoria_id bigint, cidade_id bigint, primary key (produto_id));
...
create table tb_score_produto (valor bigint, produto_id bigint not null, cliente_id bigint not null, primary key (cliente_id, produto_id));
